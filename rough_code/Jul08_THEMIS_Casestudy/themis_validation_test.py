...
cdf_file1 = cdflib.CDF(os.getcwd()+"\\thc_l2_fgm_20080702_v01.cdf") #02/07/2008 FGM level 1
...
data_end_time = matplotlib.dates.date2num(datetime.strptime('2008-07-02T18:03:00.000Z','%Y-%m-%dT%H:%M:%S.%fZ'))
...
for i in range(0,int((t_secs[-1]-t_secs[0]-t_int+shift)/shift)):
    ...
    #phi_id.append( np.arccos(abs(np.dot([x1[0],x1[1]],[B_dir[0],B_dir[1]]) \

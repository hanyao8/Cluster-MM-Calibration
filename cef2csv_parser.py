...
if (pp_text[2].split())[0] != 'cef2csv_parser':
...
#cef_file_name = "C3_CP_AUX_SPIN_AXIS__20051001_000000_20051101_000000_V130205"

SETTING= ( (pp_text[3]).split() )[1]
cef_file_name = ( (pp_text[4]).split() )[1]

...
ax1.plot_date((subintervals[:,0]+subintervals[:,1])/2/3600/24,ratiomaxmid,fmt='-',label="max-mid eigenratio")
ax1.plot_date((subintervals[:,0]+subintervals[:,1])/2/3600/24,ratiomaxmin,fmt='-',label="max-min eigenratio")
ax1.plot_date((subintervals[:,0]+subintervals[:,1])/2/3600/24,ratiomidmin,fmt='-',label="min-mid eigenratio")
ax1.plot_date((subintervals[:,0]+subintervals[:,1])/2/3600/24,a,fmt='-')
ax1.plot_date((subintervals[:,0]+subintervals[:,1])/2/3600/24,b,fmt='-')

ax1.set_title("Eigenvalues ratio vs time 2006 March")
...
ax2.plot((subintervals[:,0]+subintervals[:,1])/2,Bz_sitv_mean,linewidth=1.0)
#fig3=plt.figure()
ax3.plot_date((subintervals[:,0]+subintervals[:,1])/2/3600/24,lmax,fmt='-',label="eigmax")
ax3.plot_date((subintervals[:,0]+subintervals[:,1])/2/3600/24,lmin,fmt='-',label="eigmin")
ax3.plot_date((subintervals[:,0]+subintervals[:,1])/2/3600/24,lmid,fmt='-',label="eigmid")
ax3.set_title("Eigenvalues of MVA vs time 2006 March")
ax3.set_ylabel("variance/$nT^2$")
